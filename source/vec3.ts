/*
    functions:
        creation:
            vec3(x: number = 0.0, y?: number, z?: number): vec3_t
            vec3_new(): vec3_t
            vec3_x(x: number): vec3_t
            vec3_xyz(x: number, y: number, z: number): vec3_t
            vec3_clone(v: vec3_t): vec3_t
        setter:
            vec3_zero(v: vec3_t): vec3_t
            vec3_set(v: vec3_t, x: number, y: number, z: number): vec3_t
            vec3_copy(a: vec3_t, b: vec3_t): vec3_t
        color:
            rgb(r: number = 0.0, g: number = 0.0, b: number = 0.0): vec3_t
            hex(h: number): vec3_t
        unary:
            vec3_neg(v: vec3_t): vec3_t
            vec3_abs(v: vec3_t): vec3_t
            vec3_inv(v: vec3_t): vec3_t
        arithmetic vector x vector:
            vec3_add(a: vec3_t, b: vec3_t, out: vec3_t): vec3_t
            vec3_add1(a: vec3_t, b: vec3_t): vec3_t
            vec3_add2(a: vec3_t, b: vec3_t): vec3_t
            vec3_sub(a: vec3_t, b: vec3_t, out: vec3_t): vec3_t
            vec3_sub1(a: vec3_t, b: vec3_t): vec3_t
            vec3_sub2(a: vec3_t, b: vec3_t): vec3_t
            vec3_mul(a: vec3_t, b: vec3_t, out: vec3_t): vec3_t
            vec3_mul1(a: vec3_t, b: vec3_t): vec3_t
            vec3_mul2(a: vec3_t, b: vec3_t): vec3_t
            vec3_div(a: vec3_t, b: vec3_t, out: vec3_t): vec3_t
            vec3_div1(a: vec3_t, b: vec3_t): vec3_t
            vec3_div2(a: vec3_t, b: vec3_t): vec3_t
        arithmetic vector x scalar:
            vec3_adds(v: vec3_t, s: number, out: vec3_t): vec3_t
            vec3_adds1(v: vec3_t, s: number): vec3_t
            vec3_adds2(v: vec3_t, s: number): vec3_t
            vec3_subs(v: vec3_t, s: number, out: vec3_t): vec3_t
            vec3_subs1(v: vec3_t, s: number): vec3_t
            vec3_subs2(v: vec3_t, s: number): vec3_t
            vec3_muls(v: vec3_t, s: number, out: vec3_t): vec3_t
            vec3_muls1(v: vec3_t, s: number): vec3_t
            vec3_muls2(v: vec3_t, s: number): vec3_t
            vec3_divs(v: vec3_t, s: number, out: vec3_t): vec3_t
            vec3_divs1(v: vec3_t, s: number): vec3_t
            vec3_divs2(v: vec3_t, s: number): vec3_t
        arithmetic vector x vector x scalar:
            vec3_addmuls(a: vec3_t, b: vec3_t, s: number, out: vec3_t): vec3_t
            vec3_addmuls1(a: vec3_t, b: vec3_t, s: number): vec3_t
            vec3_addmuls2(a: vec3_t, b: vec3_t, s: number): vec3_t
        product:
            vec3_dot(a: vec3_t, b: vec3_t): number
            vec3_cross(a: vec3_t, b: vec3_t): vec3_t
            vec3_cross1(a: vec3_t, b: vec3_t): vec3_t
        norm:
            vec3_len(v: vec3_t): number
            vec3_len_sq(v: vec3_t): number
            vec3_dist(a: vec3_t, b: vec3_t): number
            vec3_dist_sq(a: vec3_t, b: vec3_t): number
            vec3_unit(v: vec3_t, out: vec3_t): vec3_t
            vec3_unit1(v: vec3_t): vec3_t
            vec3_unit2(v: vec3_t): vec3_t
            vec3_dir(a: vec3_t, b: vec3_t, out: vec3_t): vec3_t
            vec3_dir1(a: vec3_t, b: vec3_t): vec3_t
        transform:
            vec3_transf_mat3(v: vec3_t, m: mat3_t, out: vec3_t): vec3_t
            vec3_transf_mat3_1(v: vec3_t, m: mat3_t): vec3_t
            vec3_transf_mat3_2(v: vec3_t, m: mat3_t): vec3_t
            vec3_transf_mat4(v: vec3_t, m: mat4_t, out: vec3_t): vec3_t
            vec3_transf_mat4_1(v: vec3_t, m: mat3_t): vec3_t
            vec3_transf_mat4_2(v: vec3_t, m: mat3_t): vec3_t
            vec3_rotate_x(v: vec3_t, c: vec3_t, r: number, out: vec3_t): vec3_t
            vec3_rotate_x1(v: vec3_t, c: vec3_t, r: number): vec3_t
            vec3_rotate_x2(v: vec3_t, c: vec3_t, r: number): vec3_t
            vec3_rotate_y(v: vec3_t, c: vec3_t, r: number, out: vec3_t): vec3_t
            vec3_rotate_y1(v: vec3_t, c: vec3_t, r: number): vec3_t
            vec3_rotate_y2(v: vec3_t, c: vec3_t, r: number): vec3_t
            vec3_rotate_z(v: vec3_t, c: vec3_t, r: number, out: vec3_t): vec3_t
            vec3_rotate_z1(v: vec3_t, c: vec3_t, r: number): vec3_t
            vec3_rotate_z2(v: vec3_t, c: vec3_t, r: number): vec3_t
        geometric:
            vec3_refl(v: vec3_t, n: vec3_t, out: vec3_t): vec3_t
            vec3_refl1(v: vec3_t, n: vec3_t): vec3_t
        angular:
            vec3_angle(v: vec3_t): vec2_t
            vec3_angle_ab(a: vec3_t, b: vec3_t): number
        interpolation:
            vec3_lerp(a: vec3_t, b: vec3_t, t: number, out: vec3_t): vec3_t
            vec3_lerp1(a: vec3_t, b: vec3_t, t: number): vec3_t
            vec3_lerp2(a: vec3_t, b: vec3_t, t: number): vec3_t
            vec3_slerp(a: vec3_t, b: vec3_t, t: number, out: vec3_t): vec3_t
            vec3_hermite(a: vec3_t, b: vec3_t, c: vec3_t, d: vec3_t, t: number, out: vec3_t): vec3_t
            vec3_bezier(a: vec3_t, b: vec3_t, c: vec3_t, d: vec3_t, t: number, out: vec3_t): vec3_t
        random:
            vec3_rand(out: vec3_t): vec3_t
            vec3_rand1(): vec3_t
            vec3_rand_unit(scale: number, out: vec3_t): vec3_t
            vec3_rand_unit1(scale: number, out: vec3_t): vec3_t
        rounding:
            vec3_floor(v: vec3_t, out: vec3_t): vec3_t
            vec3_floor1(v: vec3_t): vec3_t
            vec3_ceil(v: vec3_t, out: vec3_t): vec3_t
            vec3_ceil1(v: vec3_t): vec3_t
            vec3_round(v: vec3_t, out: vec3_t): vec3_t
            vec3_round1(v: vec3_t): vec3_t
            vec3_trunc(v: vec3_t, out: vec3_t): vec3_t
            vec3_trunc1(v: vec3_t): vec3_t
            vec3_snap(v: vec3_t, g: vec3_t, out: vec3_t): vec3_t
            vec3_snap1(v: vec3_t, g: vec3_t): vec3_t
        bounding:
            vec3_min(a: vec3_t, b: vec3_t, out: vec3_t): vec3_t
            vec3_min1(a: vec3_t, b: vec3_t): vec3_t
            vec3_max(a: vec3_t, b: vec3_t, out: vec3_t): vec3_t
            vec3_max1(a: vec3_t, b: vec3_t): vec3_t
            vec3_clamp(v: vec3_t, min: vec3_t, max: vec3_t, out: vec3_t): vec3_t
            vec3_clamp1(v: vec3_t, min: vec3_t, max: vec3_t): vec3_t
            vec3_clamp2(v: vec3_t, min: vec3_t, max: vec3_t): vec3_t
            vec3_wrap(v: vec3_t, min: vec3_t, max: vec3_t, out: vec3_t): vec3_t
            vec3_wrap1(v: vec3_t, min: vec3_t, max: vec3_t): vec3_t
            vec3_wrap2(v: vec3_t, min: vec3_t, max: vec3_t): vec3_t
        comparison:
            vec3_equals_exact(a: vec3_t, b: vec3_t): boolean
            vec3_equals(a: vec3_t, b: vec3_t, e: number = EPSILON): boolean
        string:
            vec3_str(v: vec3_t): string
            vec3_print(v: vec3_t): void
*/
