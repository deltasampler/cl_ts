...
export function vec2_rotate_ccw(v: vec2_t, c: vec2_t, a: number) {
    const out = new TYPE(2);
    const cx = c[0], cy = c[1];
    const x = v[0] - cx;
    const y = v[1] - cy;
...
export function vec2_to_local(v: vec2_t, c: vec2_t, a: number) {
    const out = new TYPE(2);
    const cx = c[0], cy = c[1];
    const x = v[0] - cx;
    const y = v[1] - cy;
...
export function vec2_loop(v: vec2_t, min: vec2_t, max: vec2_t): vec2_t {
    const out = new TYPE(2);
...
export function vec2_loop2(v: vec2_t, min: vec2_t, max: vec2_t): vec2_t {
    const mn0 = min[0], mn1 = min[1];
    const r0 = max[0] - mn0, r1 = max[1] - mn1;
