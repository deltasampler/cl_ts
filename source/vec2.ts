/*
    functions:
        ...
        arithmetic vector x vector:
            vec2_add(a: vec2_t, b: vec2_t, out: vec2_t): vec2_t
            vec2_add1(a: vec2_t, b: vec2_t): vec2_t
            vec2_add2(a: vec2_t, b: vec2_t): vec2_t
            vec2_sub(a: vec2_t, b: vec2_t, out: vec2_t): vec2_t
            vec2_sub1(a: vec2_t, b: vec2_t): vec2_t
            vec2_sub2(a: vec2_t, b: vec2_t): vec2_t
            vec2_mul(a: vec2_t, b: vec2_t, out: vec2_t): vec2_t
            vec2_mul1(a: vec2_t, b: vec2_t): vec2_t
            vec2_mul2(a: vec2_t, b: vec2_t): vec2_t
            vec2_div(a: vec2_t, b: vec2_t, out: vec2_t): vec2_t
            vec2_div1(a: vec2_t, b: vec2_t): vec2_t
            vec2_div2(a: vec2_t, b: vec2_t): vec2_t
        arithmetic vector x scalar:
            vec2_adds(v: vec2_t, s: number, out: vec2_t): vec2_t
            vec2_adds1(v: vec2_t, s: number): vec2_t
            vec2_adds2(v: vec2_t, s: number): vec2_t
            vec2_subs(v: vec2_t, s: number, out: vec2_t): vec2_t
            vec2_subs1(v: vec2_t, s: number): vec2_t
            vec2_subs2(v: vec2_t, s: number): vec2_t
            vec2_muls(v: vec2_t, s: number, out: vec2_t): vec2_t
            vec2_muls1(v: vec2_t, s: number): vec2_t
            vec2_muls2(v: vec2_t, s: number): vec2_t
            vec2_divs(v: vec2_t, s: number, out: vec2_t): vec2_t
            vec2_divs1(v: vec2_t, s: number): vec2_t
            vec2_divs2(v: vec2_t, s: number): vec2_t
        arithmetic vector x vector x scalar:
            vec2_addmuls(a: vec2_t, b: vec2_t, s: number, out: vec2_t): vec2_t
            vec2_addmuls1(a: vec2_t, b: vec2_t, s: number): vec2_t
            vec2_addmuls2(a: vec2_t, b: vec2_t, s: number): vec2_t
        product:
        ...
        norm:
            ...
            vec2_unit(v: vec2_t, out: vec2_t): vec2_t
            vec2_unit1(v: vec2_t): vec2_t
            vec2_unit2(v: vec2_t): vec2_t
            vec2_dir(a: vec2_t, b: vec2_t, out: vec2_t): vec2_t
            vec2_dir1(a: vec2_t, b: vec2_t): vec2_t
        transform:
            vec2_transf_mat2(v: vec2_t, m: mat2_t, out: vec2_t): vec2_t
            vec2_transf_mat2_1(v: vec2_t, m: mat2_t): vec2_t
            vec2_transf_mat2_2(v: vec2_t, m: mat2_t): vec2_t
            vec2_transf_2x3(v: vec2_t, m: mat2x3_t, out : vec2_t): vec2_t
            vec2_transf_2x3_1(v: vec2_t, m: mat2x3_t): vec2_t
            vec2_transf_2x3_2(v: vec2_t, m: mat2x3_t): vec2_t
            vec2_transf_mat3(v: vec2_t, m: mat3_t, out: vec2_t): vec2_t
            vec2_transf_mat3_1(v: vec2_t, m: mat3_t): vec2_t
            vec2_transf_mat3_2(v: vec2_t, m: mat3_t): vec2_t
            vec2_transf_mat4(v: vec2_t, m: mat4_t, out: vec2_t): vec2_t
            vec2_transf_mat4_1(v: vec2_t, m: mat4_t): vec2_t
            vec2_transf_mat4_2(v: vec2_t, m: mat4_t): vec2_t
            vec2_rotate_origin(v: vec2_t, a: number, out: vec2_t): vec2_t
            vec2_rotate_origin1(v: vec2_t, a: number): vec2_t
            vec2_rotate_origin2(v: vec2_t, a: number): vec2_t
            vec2_rotate(v: vec2_t, c: vec2_t, a: number, out: vec2_t): vec2_t
            vec2_rotate1(v: vec2_t, c: vec2_t, a: number): vec2_t
            vec2_rotate2(v: vec2_t, c: vec2_t, a: number): vec2_t
        geometric:
            vec2_refl(v: vec2_t, n: vec2_t, out: vec2_t): vec2_t
            vec2_refl1(v: vec2_t, n: vec2_t): vec2_t
        angular:
            vec2_angle(v: vec2_t): number
            vec2_angle_ab(a: vec2_t, b: vec2_t): number
        interpolation:
            vec2_lerp(a: vec2_t, b: vec2_t, t: number, out: vec2_t): vec2_t
            vec2_lerp1(a: vec2_t, b: vec2_t, t: number): vec2_t
            vec2_lerp2(a: vec2_t, b: vec2_t, t: number): vec2_t
        random:
            vec2_rand(out: vec2_t): vec2_t 
            vec2_rand1(): vec2_t
            vec2_rand_unit(scale: number, out: vec2_t): vec2_t
            vec2_rand_unit1(scale: number): vec2_t
        rounding:
            vec2_floor(v: vec2_t, out: vec2_t): vec2_t
            vec2_floor1(v: vec2_t): vec2_t
            vec2_ceil(v: vec2_t, out: vec2_t): vec2_t
            vec2_ceil1(v: vec2_t): vec2_t
            vec2_round(v: vec2_t, out: vec2_t): vec2_t
            vec2_round1(v: vec2_t): vec2_t
            vec2_trunc(v: vec2_t, out: vec2_t): vec2_t
            vec2_trunc1(v: vec2_t): vec2_t
            vec2_snap(v: vec2_t, g: vec2_t, out: vec2_t): vec2_t
            vec2_snap1(v: vec2_t, g: vec2_t): vec2_t
        bounding:
            vec2_min(a: vec2_t, b: vec2_t, out: vec2_t): vec2_t
            vec2_min1(a: vec2_t, b: vec2_t): vec2_t
            vec2_max(a: vec2_t, b: vec2_t, out: vec2_t): vec2_t
            vec2_max1(a: vec2_t, b: vec2_t): vec2_t
            vec2_clamp(v: vec2_t, min: vec2_t, max: vec2_t, out: vec2_t): vec2_t
            vec2_clamp1(v: vec2_t, min: vec2_t, max: vec2_t): vec2_t
            vec2_clamp2(v: vec2_t, min: vec2_t, max: vec2_t): vec2_t
            vec2_wrap(v: vec2_t, min: vec2_t, max: vec2_t, out: vec2_t): vec2_t
            vec2_wrap1(v: vec2_t, min: vec2_t, max: vec2_t): vec2_t
            vec2_wrap2(v: vec2_t, min: vec2_t, max: vec2_t): vec2_t
        comparison:
