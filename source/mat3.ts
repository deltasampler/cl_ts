...
export function cl_mat3_new(): mat3_t {
    const out = new TYPE(9);
...
export function cl_mat3_clone(m: mat3_t): mat3_t {
    const out = new TYPE(9);
...
export function cl_mat3_copy(a: mat3_t, b: mat3_t): mat3_t {
    a[0] = b[0];
    a[1] = b[1];
    a[2] = b[2];
    a[3] = b[3];
...
export function cl_mat3_ident(m: mat3_t): mat3_t {
    m[0] = 1.0;
    m[1] = 0.0;
    m[2] = 0.0;
    m[3] = 0.0;
...
export function cl_mat3_mul(a: mat3_t, b: mat3_t): mat3_t {
    const out = new TYPE(9);
...
export function cl_mat3_mul2(a: mat3_t, b: mat3_t): mat3_t {
    const a00 = a[0], a01 = a[1], a02 = a[2],
          a10 = a[3], a11 = a[4], a12 = a[5],
          a20 = a[6], a21 = a[7], a22 = a[8];
    const b00 = b[0], b01 = b[1], b02 = b[2],
...
export function cl_mat3_mul_mv(m: mat3_t, v: vec3_t): vec3_t {
...
export function cl_mat3_mul_vm(v: vec3_t, m: mat3_t): vec3_t {
    const out = new TYPE(3);
    const x = v[0], y = v[1], z = v[2];
...
export function cl_mat3_str(m: mat3_t): string {
    return "mat3(\n" +
        `\t${m[0]}, ${m[3]}, ${m[6]},\n` +
        `\t${m[1]}, ${m[4]}, ${m[7]},\n` +
        `\t${m[2]}, ${m[5]}, ${m[8]}\n` +
...
export function cl_mat3_print(m: mat3_t): void {
    console.log(cl_mat3_str(m));
}
